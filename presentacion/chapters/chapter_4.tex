\section{CaracterizaciÛn y tests}
...
\begin{frame}{Listado de pruebas}
  \begin{itemize}
	\item<1-> TransformaciÛn de seÒales patrÛn
	\item<2-> MediciÛn del error
	\item<3-> MediciÛn de la THD
	\item<4-> Efecto del escalamiento
	\item<5-> MediciÛn de los recursos necesarios 
    \item<6-> ComparaciÛn con core FFT abierto para modulaciÛn OFDM/ISDB-T
  \end{itemize}
\end{frame}

% \subsection{SeÒales PatrÛn}
% 
% \begin{frame}{SeÒales patrÛn}
%   \uncover<1->{
%   \begin{itemize}
%     \item<1-> Se realizaron pruebas utilizando como entrada deltas en diferentes compoenentes y se
%     analizÛ su salida. Por ejemplo:
%     \begin{itemize}
%       \item<2-> Una delta en posiciÛn `0'
%       \item<3-> Una delta en posiciÛn `6'
%     \end{itemize}
%   \end{itemize}
%   }
%   \uncover<2->{
...
\subsection{MediciÛn del error}
\begin{frame}{MediciÛn del error}%{M√©tricas de error}
%   \only<1-8>{
%   \begin{itemize}
%     \item<1-> Las m√©tricas utilizadas para estimar el error fueron
%     \begin{itemize}
...
%     \begin{itemize}
%       \item<5-> Se cre√≥ una entrada aleatoria para cada simulaci√≥n
%       \item<6-> Se calcul√≥ el error en cada simulaci√≥n y luego se promedi√≥
%       \item<7-> Se realiz√≥ para cada arquitectura
%       \item<8-> Se utiliz√≥ el c√°lculo de FFT de la se√±al de entrada en Matlab como referencia para
%       el c√°lculo de error
%     \end{itemize}
%     \item<9-> Se contrast√≥ con el error de una arquitectura de c√≥mputo de FFT de terceros: KISS
%       FFT en C++
%   \end{itemize}
%   }
...
\begin{frame}{Resultados de la mediciÛn de error}
...
\subsection{MediciÛn de la THD}
% \begin{frame}{MediciÛn de la THD}
% %   \only<1-5>{
% %   \begin{itemize}
...
% %     \item<3-> Se midi√≥ la THD para entradas delta en cada una de las componentes para cada
% %     arquitectura
% %     \item<4-> Se tom√≥ la salida de cada simulaci√≥n y se calcul√≥ la THD mediante Matlab.
% %     \item<5-> Se contrast√≥ con la THD de la arquitectura Kiss FFT en C++.
% %   \end{itemize}
% %   }
%   
% %  \only<6>{
...
% \begin{frame}{An√°lisis de la intermodulaci√≥n}
% %   \begin{itemize}
% %     \item<1-> Se midi√≥ la THD para un tono determinado
% %     \item<2-> Se midi√≥ la THD para una se√±al que contiene el mismo tono y el tono inmediato
% %     anterior, y se compar√≥ con la THD anterior
% %   \end{itemize}
% %   \uncover<3-4>{
% %   \begin{columns}[T]
% %     \begin{column}{.5\textwidth}
% % \begin{itemize}
% %   \item<1-> Se√±al que produce overflow 
%       \begin{center}
%         \advance\leftskip-0.2cm
...
% 	
% % 	\begin{column}{.5\textwidth}
% %   \item<2-> Se√±al con produce overflow
% 	  \begin{center}
% 	    \advance\leftskip-0.2cm
...
% %   }
% %   \begin{itemize}
% %     \item<4-4> Se observa que no hay efectos de intermodulaci√≥n 
% %   \end{itemize}
% \end{frame}
...
% \begin{frame}{}
%   \begin{itemize}
%     \item<1-> Ensayos de verificaci√≥n
%     \begin{itemize}
%       \Fontitit
%       \item<1-> Transformaci√≥n de se√±ales patr√≥n
%     \end{itemize}
%     \item<1-> Ensayos de caracterizaci√≥n
%     \begin{itemize}
%       \Fontitit
%       \item<1-> Medici√≥n del error
%       \item<1-> Medici√≥n de la THD
%       \item<1-> \color<1->[rgb]{0,0.6,0}Efecto del escalamiento
%       \item<1-> Medici√≥n de los recursos necesarios 
%     \end{itemize}
%     \item<1-> Ensayos de validaci√≥n
%     \begin{itemize}
%       \Fontitit
%       \item<1-> Implementaci√≥n en FPGA
%     \end{itemize}
%   \end{itemize}
% \end{frame}
% 
% \begin{frame}{Efecto sobre la se√±al de salida}
%   \begin{itemize}
%     \item<1-> Provoca un escalamiento por $1/2$ por cada etapa donde se realiza escalamiento
%     \item<2-> Provoca una p√©rdida de informaci√≥n
%   \end{itemize}
%   
%   \uncover<3-3>{
%     \begin{center}
...
%   \begin{itemize}
% %     \item<1-> Se utilizaron dos se√±ales compuestas por una delta en una componente
% %     \item<2-> Una dentro del rango de funcionamiento seguro y una que provoca overflow
% %     \item<3-> Se simul√≥ con escalamiento en cada etapa y se midi√≥ la THD en cada caso
% %   \end{itemize}
% %   
% %   \uncover<4-4>{
% %   \begin{columns}[T]
% %     \begin{column}{.5\textwidth}
%      \item<1-> Se√±al sin producir overflow
% 	  \begin{center}
% 		  \advance\leftskip-0.2cm
...
% %     \end{column}
% %     \begin{column}{.5\textwidth}
%       \item<2-> Se√±al que provoca overflow
% 		\begin{center}
% 		  \advance\leftskip-0.2cm
...
\subsection{Recursos de ImplementaciÛn}
% \begin{frame}{Recursos de implementaciÛn}
%     \begin{columns}[T]
%       \begin{column}{.53\textwidth}
%       \begin{itemize}
%         \item<1-> Uno de los requerimientos es la economÌa de recursos
%         \item<2-> FPGA XC5VLX110, de la familia Virtex-5 de Xilinx.
%         \item<3-> Se comparÛ con dos arquitecturas
%         \begin{itemize}
...
\begin{frame}{TamaÒo de implementaciÛn para 1024 puntos}
%  \uncover<3-3>{
%   \begin{columns}[T]
%     \begin{column}{.5\textwidth}
...
\begin{frame}{TamaÒo de implementaciÛn para 4096 puntos}
%     \begin{column}{.5\textwidth}
		\begin{center}
		  %\advance\leftskip-0.2cm
...
% \subsection{ImplementaciÛn en hardware}
% 
% \begin{frame}{}%{Listado de pruebas}
%   \Fontit
%   \begin{itemize}
...
%     \begin{itemize}
%       \Fontitit
%       \item<1-> \color<1->[rgb]{0,0.6,0}Implementaci√≥n en FPGA
%     \end{itemize}
%   \end{itemize}
% \end{frame}
% 
% \begin{frame}{Validaci√≥n en hardware}
%   \only<1-2,4-5>{
%     
%       \begin{columns}[T]
%         \begin{column}{.5\textwidth}
...
%             \item<2-> Se implement√≥ adicionalmente una unidad de comuniaci√≥n UART y una memoria
%        auxiliar.
%           \end{itemize}
%         \end{column}
%         \begin{column}{.5\textwidth}
...
%       \end{columns}
%       \begin{itemize}
%         \item<4-> Se utilizaron como entrada las se√±ales patr√≥n ya utilizadas previamente, y se√±ales
%         aleatorias para las que se calcul√≥ el error.
...
\subsection{ComparaciÛn con IP Core FFT abierto}
\begin{frame}{ComparaciÛn con IP Core FFT abierto}
	\begin{itemize}
	  \item<1-> IP Core abierto para modulaciÛn/demodulaciÛn OFDM para ISDB-T (Melo, R., Salom\'on, F., Valinoti, B., (2016) ``IP core FFT configurable en Runtime'')
	  \item<2-> ComparaciÛn con la versiÛn b·sica del IP Core, 8K muestras, 16 bits 
	\end{itemize}
