...
\begin{frame}{Objetivos}
  ...
  \begin{itemize}
    ...
    software que cumpla con el estándar ISDB-T
    ...
    \item<3-> Requerimientos
      \begin{itemize}
		  ...
		  (ISDB-T).
		  \item<5-> Frecuencia de muestreo mínima de $8,126,984$ (según estándar ISDB-T)
		  \item<6-> Entrada y salida continua
		  \item<7-> Aritmética de punto fijo
		  \item<8-> Unidad de escalamiento configurable en ejecución con opción de seleccionar la etapa a escalar y el método (redondeo/truncamiento)
		  \item<9-> Bajo consumo de recursos comparados con otras
		  implementaciones\footnotemark \footnotemark
	  \end{itemize}
	\end{itemize}
	\uncover<9->{
	\footnotetext[1]{Implementación abierta orientada a ISDB-T: Melo, R.,
	Salom\'on, F., Valinoti, B., (2016) ``IP core FFT configurable en Runtime''}
	\footnotetext[2]{Implementación propietaria Xilinx LogiCORE FFT 7.1}}
\end{frame}

\begin{frame}{Objetivos}
  \Fontit
  \begin{itemize}
    \item<1-> Realizar una evaluación de desempeño
    \begin{itemize}
      \Fontitit
      \item<2-> Funcional
      \item<3-> Ruido / error
      \item<4-> Distorsión armónica
      \item<5-> Recursos de HW
    \end{itemize}
    \item<6-> Realizar una comparativa con desarrollos de terceros para evaluar el diseño realizado
    \item<7-> Proponer trabajos futuros para continuar y mejorar el diseño.
 \end{itemize}
\end{frame}
